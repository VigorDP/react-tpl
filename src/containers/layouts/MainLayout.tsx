...
import XinTaiPage from 'containers/pages/main/XinTaiPage'
import XinTaiMorePage from 'containers/pages/main/XinTaiMorePage'
import XinTaiMoreDetailPage from 'containers/pages/main/XinTaiMoreDetailPage'

import GongYiPage from 'containers/pages/main/GongYiPage'
import CaiZhiPage from 'containers/pages/main/CaiZhiPage'
